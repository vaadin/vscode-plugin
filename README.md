...
You can create new Vaadin projects using `Vaadin: Generate new Vaadin project` command. Choose if you want to add example Flow views, enable authentication and use stable or prerelease.
