 ...
 * To update run 'ampli pull vscode'
 *
 ...
 *
 * [Full Setup Instructions](https://data.amplitude.com/vaadin/IDE%20Plugins/implementation/vscode)
 */
...
export type Environment = 'ideplugins';

export const ApiKey: Record<Environment, string> = {
  ideplugins: '5332f8777b8ce7f12dcbf6c9d749488d'
};
...
export const DefaultConfiguration: NodeOptions = {
  plan: {
    ...
    branch: 'main',
    source: 'vscode',
    versionId: 'ac62c3f9-e92b-4502-8a50-3fd8f13c4103'
  },
  ...{
    ingestionMetadata: {
...
export interface PluginInitializedProperties {
  ProKey?: string;
  Vaadiner: boolean;
}
...
export class ManualCopilotRestart implements BaseEvent {
  event_type = 'ManualCopilotRestart';

  constructor(
    public event_properties: ManualCopilotRestartProperties,
  ) {
    this.event_properties = event_properties;
  }
}

export class PluginInitialized implements BaseEvent {
  event_type = 'PluginInitialized';

  constructor(
    public event_properties: PluginInitializedProperties,
  ) {
    this.event_properties = event_properties;
  }
}

export class ProjectCreated implements BaseEvent {
  event_type = 'ProjectCreated';

  constructor(
    public event_properties: ProjectCreatedProperties,
  ) {
    this.event_properties = event_properties;
  }
}
...
export class Ampli {
   ...
   * Identify
   *
   * [View in Tracking Plan](https://data.amplitude.com/vaadin/IDE%20Plugins/events/main/latest/Identify)
   *
  ...
  identify(
    ...
    return this.track(userId, new Identify(), options);
  }
  ...
  manualCopilotRestart(
    userId: string | undefined,
    properties: ManualCopilotRestartProperties,
    options?: EventOptions,
  ) {
    return this.track(userId, new ManualCopilotRestart(properties), options);
  }
   ...
   *
   * @param userId The user's ID.
   * @param properties The event's properties (e.g. ProKey)
   * @param options Amplitude event options.
   */
  pluginInitialized(
    userId: string | undefined,
    properties: PluginInitializedProperties,
    options?: EventOptions,
  ) {
    return this.track(userId, new PluginInitialized(properties), options);
  }
   ...
   *
   * @param userId The user's ID.
   * @param properties The event's properties (e.g. downloadUrl)
   * @param options Amplitude event options.
   */
  projectCreated(
    userId: string | undefined,
    ...
    return this.track(userId, new ProjectCreated(properties), options);
  }
}
